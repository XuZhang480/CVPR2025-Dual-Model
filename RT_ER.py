...
def main():
    ...
    parser.add_argument('--beta', default='6', type=int, help="parameter for the proportion experts specification")
        ...
        for batch_idx, (inputs, targets) in enumerate(loaders['train']):
            ...
            with torch.cuda.amp.autocast(enabled=use_amp):
                ...
                for expert in moe_module.experts:
                    expert = torch.nn.DataParallel(expert)
                    ...
                    loss_expert += criterion_kl(F.log_softmax(expert_outputs_adv, dim=1),
